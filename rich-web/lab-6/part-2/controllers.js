...
contactManager.controller('AddCtrl', ['$scope', function($scope) {
...
contactManager.controller('RemoveCtrl', ['$scope', function($scope) {
  $scope.remove = function(contact) {
    $scope.contacts.splice($scope.contacts.indexOf(contact));
  };
}]);
